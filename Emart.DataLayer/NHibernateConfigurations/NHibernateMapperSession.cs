...
namespace EMart.DataLayer
{
    public class NHibernateMapperSession : IMapperSession
    {
        ...
        public IQueryable<Products> products => _session.Query<Products>();
        ...
        public async System.Threading.Tasks.Task Save(Products entity)
        {
            await _session.SaveOrUpdateAsync(entity);
        }

        public async System.Threading.Tasks.Task Delete(Products entity)
        {
